...
export default function HostDashboard({ cars, bookings, onSelectTrip, onNavigateToTab }: HostDashboardProps) {
  ...
  return (
    <div className="w-full h-full bg-black text-white flex flex-col overflow-y-auto no-scrollbar pb-28 text-right px-5 pt-5" dir="rtl">
      ...
      <div className="flex justify-between items-center mb-6">
        ...
        <div className="bg-[#5c61ec]/10 border border-[#5c61ec]/10 px-3 py-1.5 rounded-full flex items-center gap-2 text-[10px] font-black text-[#5c61ec] shadow-[0_2px_10px_rgba(92,97,236,0.15)] select-none">
      ...
      <div className="grid grid-cols-2 gap-3.5 mb-6">
        {/* Earnings Card */}
        <div className="bg-zinc-900 border border-zinc-950 p-4.5 rounded-[22px] flex flex-col justify-between hover:border-zinc-900 transition-all duration-300 relative overflow-hidden group shadow-lg">
          ...
          <div className="flex justify-between items-start z-10">
            <div className="p-2.5 bg-[#5c61ec]/10 border border-[#5c61ec]/10 rounded-xl text-[#5c61ec] shadow-[inset_0_1px_1px_rgba(255,255,255,0.05)]">
              <DollarSign className="w-4 h-4" />
            </div>
            <span className="text-[9px] bg-emerald-500/10 text-emerald-400 rounded-md px-1.5 py-0.5 leading-none font-black">جاهز للسحب</span>
          </div>
        ...
        <div className="bg-zinc-900 border border-zinc-950 p-4.5 rounded-[22px] flex flex-col justify-between hover:border-zinc-900 transition-all duration-300 relative overflow-hidden group shadow-lg">
          ...
          <div className="flex justify-between items-start z-10">
            <div className="p-2.5 bg-emerald-500/10 border border-emerald-500/10 rounded-xl text-emerald-400 shadow-[inset_0_1px_1px_rgba(255,255,255,0.05)]">
              <Percent className="w-4 h-4" />
            </div>
            <span className="text-[9px] bg-[#5c61ec]/10 text-[#5c61ec] rounded-md px-1.5 py-0.5 leading-none font-black font-sans">99% رضا</span>
          </div>
          <div className="mt-5 z-10">
        ...
        {/* Upcoming Trips Card */}
        <div className="bg-zinc-900 border border-zinc-950 p-4.5 rounded-[22px] flex flex-col justify-between hover:border-zinc-900 transition-all duration-300 relative overflow-hidden group shadow-lg cursor-pointer" onClick={() => onNavigateToTab("host_trips")}>
          ...
          <div className="flex justify-between items-start z-10">
            <div className="p-2.5 bg-purple-500/10 border border-purple-500/10 rounded-xl text-purple-400 shadow-[inset_0_1px_1px_rgba(255,255,255,0.05)]">
        ...
        <div className="bg-zinc-900 border border-zinc-950 p-4.5 rounded-[22px] flex flex-col justify-between hover:border-zinc-900 transition-all duration-300 relative overflow-hidden group shadow-lg">
          ...
          <div className="flex justify-between items-start z-10">
            <div className="p-2.5 bg-blue-500/10 border border-blue-500/10 rounded-xl text-blue-400 shadow-[inset_0_1px_1px_rgba(255,255,255,0.05)]">
              <MessageSquare className="w-4 h-4" />
            </div>
            <span className="text-[9px] bg-blue-500/10 text-blue-400 rounded-md px-1.5 py-0.5 leading-none font-black font-sans">صندوق البريد</span>
          </div>
          <div className="mt-5 z-10">
      ...
      <div className="bg-zinc-900 border border-zinc-950 p-4.5 rounded-[24px] mb-6 shadow-xl relative overflow-hidden">
        <div className="flex justify-between items-center mb-4 border-b border-zinc-950 pb-3">
        ...
        <div className="grid grid-cols-3 gap-1 py-1.5">
          ...
          <div className="border-r border-zinc-950 text-center">
      ...
      <div className="mb-6">
        ...
        {hostBookings.length === 0 ? (
          <div className="bg-zinc-900 border border-zinc-950 p-8 rounded-[24px] text-center shadow-lg">
            ...
            {hostBookings.slice(0, 3).map((trip) => {
              ...
              return (
                <div 
                  ...
                  className="bg-zinc-900 border border-zinc-950 p-3.5 rounded-[22px] flex gap-3.5 text-right cursor-pointer shadow-lg transition-all duration-300 relative group"
                >
                  <div className="relative shrink-0 w-[96px] h-[66px] bg-zinc-950 overflow-hidden rounded-xl">
                  ...
                  <div className="flex-1 min-w-0 flex flex-col justify-between">
                    <div>
                      <div className="flex justify-between items-start">
                        ...
                        <span className={`text-[8.5px] px-2 py-0.5 rounded-md font-black shrink-0 ${
                          trip.status === "confirmed" ? "bg-emerald-500/10 text-emerald-400" :
                          trip.status === "pending" ? "bg-amber-500/10 text-amber-400 animate-pulse" :
                    ...
                    <div className="flex justify-between items-center pt-2 mt-1 border-t border-zinc-950">
      ...
      <div className="bg-zinc-900 border border-zinc-950 p-5 rounded-[24px] text-right shadow-xl relative overflow-hidden group">
