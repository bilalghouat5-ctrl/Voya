...
export default function BookingsTab({ 
  ...
  return (
    <div id="bookings-tab-view" className={`relative flex flex-col h-full bg-black text-white overflow-hidden ${isRtl ? "text-right" : "text-left"}`} dir={dir}>
      ...
      <div className="relative flex items-center justify-center w-full h-16 shrink-0 bg-black border-b border-zinc-900/30 sticky top-0 z-20">
        <h1 className="text-[17px] font-black text-white tracking-wide">{t("الرحلات")}</h1>
      </div>
            ...
            {selectedList.length === 0 ? (
              <div className="flex flex-col items-center justify-center text-center py-6 px-4 max-w-md mx-auto">
                ...
                <h2 className="text-xl font-black text-white mt-5 tracking-tight leading-snug">
                  {user.isGuest ? "تتبع رحلاتك وحجوزاتك" : "لا توجد رحلات قادمة بعد"}
                </h2>
                
                <p className="text-[12px] text-zinc-400 font-medium leading-relaxed max-w-sm mt-2.5 px-6">
                  {user.isGuest 
                    ? "سجل الدخول الآن للاطلاع على حجوزاتك النشطة، السابقة والملغاة، وتأكيد كراء السيارات." 
                    : <>اكتشف آلاف السيارات المتاحة على <span className="font-extrabold text-zinc-300">درايف RENT</span> واحجز رحلتك القادمة.</>}
                </p>
            ...
            >
              <div className="flex justify-between items-center pb-3 border-b border-zinc-900 shrink-0">
                ...
                <button
                  ...
                  className="p-1.5 rounded-full bg-white/[0.08] backdrop-blur-[12px] border border-white/20 text-zinc-400 hover:text-white hover:bg-white/[0.18] hover:border-white/35 active:scale-95 transition-all duration-300 cursor-pointer flex items-center justify-center shadow-md"
                  title="إغلاق"
                >
          ...
          <div className="absolute inset-0 z-50 flex items-center justify-center bg-black/90 backdrop-blur-xs p-5 text-white text-right" dir="rtl">
            ...
            >
              ...
              <p className="text-[10px] text-zinc-500 mb-6 font-semibold leading-relaxed">
                ملاحظة: هذا اتصال افتراضي ومحاكاة مدمجة داخل تطبيق درايف RENT الجزائر لسهولة تواصل الأعضاء مع الوكالات المعتمدة.
              </p>
                ...
                <div className="flex gap-4 items-center justify-start">
                  ...
                  <div className="text-right space-y-1">
                    ...
                    <div className="flex gap-2 items-start mt-1.5 bg-[#5c61ec]/10 border border-[#5c61ec]/20 rounded-xl p-2 max-w-[270px]">
                      ...
                      <div className="text-right">
                        <span className="text-[9.5px] font-black text-white block">مضيف متميز • درايف RENT Partner</span>
