      ...
      <AnimatePresence mode="wait">
        {!selectedCar ? (
          ...
          >
            ...
            {hostCars.length === 0 ? (
              <div className="flex-1 flex flex-col items-center justify-center py-20 text-center bg-zinc-900 border border-zinc-850 rounded-[24px] p-6">
                <div className="p-4 bg-zinc-950 rounded-full flex items-center justify-center border border-white/[0.05] mb-4">
                ...
                {hostCars.map((car) => (
                  ...
                  >
                    <div className="flex gap-4">
                      <div className="relative shrink-0 w-[110px] h-[76px] bg-zinc-950 overflow-hidden rounded-xl border border-white/[0.05]">
                        <img 
                          src={car.image} 
                        ...
                        <div>
                          <div className="flex justify-between items-start">
                            ...
                            <span className={`text-[8.5px] px-2 py-0.5 rounded-md font-black shrink-0 ${
                              car.isAvailable ? "bg-emerald-500/10 text-emerald-400 border border-emerald-500/15" : "bg-zinc-850 text-zinc-450 border border-zinc-800"
                            }`}>
                    ...
                    <div className="flex justify-between items-center border-t border-white/[0.03] pt-3 mt-0.5">
          ...
          >
            ...
            <div className="w-full bg-[#111113] border-b border-white/[0.02] flex shrink-0 overflow-x-auto no-scrollbar text-[11px] font-black h-12" dir="rtl">
              {[
                { id: "desc", label: "الوصف" },
                ...
                <button
                  ...
                  className={`px-4 text-center shrink-0 relative transition-all duration-300 h-full flex items-center justify-center cursor-pointer select-none focus:outline-none text-xs font-bold leading-none ${
                    editTab === tab.id ? "text-[#5c61ec] font-black bg-white/[0.01]" : "text-zinc-500 hover:text-zinc-300 hover:bg-white/[0.005]"
                  }`}
                >
                  <span>{tab.label}</span>
                  {editTab === tab.id && (
            ...
            <div className="flex-1 p-4 overflow-y-auto no-scrollbar pb-24 bg-[#030303]">
              <AnimatePresence mode="wait">
                {editTab === "desc" && (
