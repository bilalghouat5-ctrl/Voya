      ...
      <AnimatePresence mode="wait">
        {subView === "menu" ? (
          ...
          >
            ...
            {/* Switch Mode CTA Row */}
            <div className="mx-6 my-2 bg-gradient-to-r from-zinc-950 to-zinc-900 hover:from-zinc-900 hover:to-zinc-950 border border-zinc-950 p-4.5 rounded-[22px] text-right flex justify-between items-center transition-all shadow-lg">
              <div>
            ...
            <div className="px-6 mt-4 space-y-1">
              ...
              <button 
                ...
                className="w-full py-4.5 px-3 flex items-center justify-between rounded-xl hover:bg-zinc-900/[0.2] active:bg-zinc-950 transition-colors cursor-pointer text-right border-none bg-transparent"
              >
                <div className="flex items-center gap-4">
              ...
              <div className="h-[1px] bg-zinc-950 w-full" />
          ...
          >
            <div className="h-16 border-b border-zinc-950 bg-[#111113] flex items-center px-4 justify-between shrink-0" dir="rtl">
            ...
            <div className="p-5 space-y-5 text-right" dir="rtl">
              <div>
                ...
                <input
                  ...
                  className="w-full bg-[#121215]/90 border border-zinc-950 focus:border-[#5c61ec] rounded-2xl p-3.5 text-xs text-white focus:outline-none transition-all font-medium"
                />
              </div>
              ...
              <div>
                ...
                <textarea
                  ...
                  className="w-full bg-[#121215]/90 border border-zinc-950 focus:border-[#5c61ec] rounded-2xl p-3.5 text-xs text-white outline-none min-h-[105px] leading-relaxed transition-all font-medium"
                />
              </div>

              <div className="bg-[#121215] p-3.5 rounded-2xl flex items-center justify-start gap-2 border border-zinc-950">
          ...
          >
            ...
            <div className="p-5 space-y-5" dir="rtl">
              ...
              <div className="bg-gradient-to-br from-[#121215] to-[#0a0a0c] border border-zinc-950 rounded-[24px] p-6 text-right relative overflow-hidden shadow-2xl">
                <div className="flex justify-between items-start">
                  <div className="p-2 bg-[#5c61ec]/10 border border-[#5c61ec]/10 rounded-xl text-[#5c61ec]">
                    <TrendingUp className="w-5 h-5 stroke-[2]" />
                  </div>
                  <span className="text-[9.5px] bg-emerald-500/10 border border-emerald-500/10 px-3 py-1 rounded-full text-emerald-400 font-black">مكتمل وبث فوري</span>
                </div>
                ...
                <div className="border-t border-zinc-950 pt-4 mt-5 flex justify-between text-right text-[11px]">
                  <div>
              ...
              <div className="bg-[#111113] p-4 border border-zinc-950 rounded-2xl">
              ...
              <div className="text-right">
                ...
                <div className="space-y-3 font-sans">
                  <div className="bg-zinc-900 border border-zinc-950 p-4 text-right rounded-2xl flex justify-between items-center shadow-sm">
                    <div>
          ...
          >
            ...
            <div className="p-5 space-y-5 text-right" dir="rtl">
              ...
              {showDocUploadedAlert && (
                <div className="bg-emerald-500/10 border border-emerald-500/10 p-4 rounded-2xl text-emerald-400 text-xs font-black text-right shadow-sm select-none">
              ...
              <div className="space-y-4 font-sans">
                ...
                <div 
                  ...
                  className="bg-zinc-900 border border-zinc-950 hover:border-zinc-900 p-4.5 rounded-[22px] flex justify-between items-center cursor-pointer transition-all active:scale-98 group shadow-sm"
                >
                  <div className="text-right">
                  ...
                  <div className="p-2.5 bg-[#5c61ec]/10 border border-[#5c61ec]/10 rounded-xl text-[#5c61ec] shrink-0">
                ...
                >
                  ...
                  <div className="p-2.5 bg-zinc-950 border border-zinc-950 rounded-xl text-zinc-500 shrink-0">
                    <UploadCloud className="w-4 h-4" />
                  </div>
                </div>
          ...
          >
            ...
            <div className="p-5 space-y-5 text-right leading-relaxed font-sans text-xs" dir="rtl">
              <div className="bg-zinc-900 border border-zinc-950 p-5 rounded-[24px]">
