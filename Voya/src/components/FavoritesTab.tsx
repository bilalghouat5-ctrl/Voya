...
export default function FavoritesTab({ cars, onSelectCar, onChangeTab, onSetHideBottomNav }: FavoritesTabProps) {
  ...
  return (
    <div id="favorites-tab-view" className={`relative flex flex-col h-full bg-black text-white overflow-y-auto no-scrollbar pb-24 select-none ${isRtl ? "text-right" : "text-left"}`} dir={dir}>
      ...
      <div className="relative flex items-center justify-center w-full h-16 shrink-0 bg-black border-b border-zinc-900/30 sticky top-0 z-20">
        <h1 className="text-[17px] font-black text-white tracking-wide">{t("المفضلة")}</h1>
      </div>
