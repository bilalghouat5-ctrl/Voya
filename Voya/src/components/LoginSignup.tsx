        ...
        <div className="relative h-full w-full flex flex-col justify-between p-6 pb-12 z-10">
          ...
          <div className="flex flex-col items-center justify-center text-center px-4 space-y-6">
            ...
            >
              <svg 
                viewBox="0 0 100 100" 
                className="w-24 h-24 text-white drop-shadow-[0_4px_12px_rgba(255,255,255,0.15)]" 
                fill="none" 
                stroke="currentColor" 
                strokeWidth="4" 
                strokeLinecap="round" 
              ...
              >
                {/* The cabin */}
                <path d="M 28 42 V 32 C 28 25, 34 20, 42 20 H 58 C 66 20, 72 25, 72 32 V 42" />
                {/* The middle body */}
                <rect x="14" y="42" width="72" height="23" rx="10" />
                {/* The wheels */}
                <circle cx="32" cy="65" r="7" fill="#000000" stroke="currentColor" strokeWidth="4" />
                <circle cx="68" cy="65" r="7" fill="#000000" stroke="currentColor" strokeWidth="4" />
              </svg>
            </motion.div>
      ...
      >
        ...
        <div className="flex-1 px-6 pt-4 pb-8 flex flex-col justify-between">
          ...
          <div className="text-center pt-4 select-none">
            <button
              onClick={() => alert("سياسة الخصوصية وشروط الخدمة لمنصة درايف RENT كراء السيارات في الجزائر.")}
            ...
            <div className="space-y-4 pt-4">
              ...
              <div className="flex items-start gap-3">
                ...
                <div className="flex flex-col text-right leading-relaxed select-none">
                  ...
                  <button
                    type="button"
                    onClick={() => alert("شروط الخدمة وسياسة الخصوصية لمنصة درايف RENT كراء السيارات في الجزائر.")}
    ...
    return (
      ...
      >
        ...
        <div className="flex-1 overflow-y-auto no-scrollbar px-6 pt-5 pb-8 flex flex-col justify-between">
          ...
          {/* Legal policy footer mirroring screenshot */}
          <div className="text-center pt-8 pb-3 px-4 select-none mt-auto">
            <p className="text-[11px] text-zinc-500 leading-relaxed max-w-xs mx-auto">
              بتسجيل الدخول، فإنك توافق على شروط الخدمة لشركة درايف RENT و{" "}
              <button
                type="button"
                onClick={() => alert("سياسة الخصوصية لمنصة درايف RENT كراء السيارات في الجزائر.")}
