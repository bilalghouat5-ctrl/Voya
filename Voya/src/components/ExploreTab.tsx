            ...
            >
              ...
              <div className="h-16 bg-[#000000] flex items-center px-4 justify-between shrink-0 select-none border-b border-zinc-900/60" dir="rtl">
                ...
                <button
                  ...
                  className="w-10 h-10 rounded-full bg-zinc-900 border border-zinc-800/80 hover:bg-zinc-850 active:scale-95 transition-all flex items-center justify-center text-zinc-400 hover:text-white cursor-pointer"
                  aria-label="إغلاق"
                >
                  <X className="w-5 h-5 text-white" />
                </button>
