...
export default function ProfileTab({ user, onUpdateUser, onAddNotification, onSetHideBottomNav, onChangeTab, onShowLoginSignup }: ProfileTabProps) {
      ...
      {user?.isGuest ? (
        ...
        <>
          ...
          <div className="flex flex-col" dir="rtl">
            ...
            <button 
              onClick={() => {
                if (window.confirm("هل ترغب حقاً في تسجيل الخروج والعودة لوضع الزائر؟")) {
                  const guestUser = {
                    id: "guest",
                    name: "زائر",
                    email: "",
            ...
            <div className="px-6 mt-4 mb-16 select-none text-right">
              <span className="text-[11px] font-medium text-zinc-650 tracking-wide font-mono">
                Version 26.22.0
              </span>
            </div>
          </div>
