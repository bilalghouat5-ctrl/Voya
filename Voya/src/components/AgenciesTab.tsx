          ...
          <div className="absolute inset-0 z-50 bg-black flex flex-col text-white text-right font-sans overflow-hidden" dir="rtl">
            ...
            <div className="flex-1 overflow-y-auto no-scrollbar pb-28 text-right">
              ...
              <div className="px-5 mt-6 space-y-4">
                ...
                <div className="pt-3 select-none" dir="rtl">
                  <button
                    onClick={() => {
                    ...
                    className="w-full py-3.5 bg-transparent border border-zinc-800 hover:bg-zinc-900 hover:border-zinc-700 text-white rounded-[14px] text-[12px] font-bold transition-all active:scale-[0.98] cursor-pointer text-center font-sans tracking-tight"
                  >
                    عرض 32 سيارة أخرى
                  </button>
                </div>
