    ...
    <div className="fixed inset-0 z-50 bg-black/75 backdrop-blur-xs flex justify-end text-right text-white">
      ...
      >
        ...
        <div className="flex justify-between items-center pb-4 border-b border-zinc-900 shrink-0">
          <button
            onClick={onClose}
            className="w-9 h-9 rounded-full bg-white/[0.08] backdrop-blur-[12px] border border-white/20 text-zinc-450 hover:text-white hover:bg-white/[0.18] hover:border-white/35 active:scale-95 transition-all duration-300 flex items-center justify-center cursor-pointer shadow-md"
            title="إغلاق التقرير"
          >
            <X className="w-5 h-5" />
          </button>
